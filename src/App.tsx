          ...
          <div className="flex flex-col md:flex-row gap-4 p-6 w-full max-w-6xl min-w-[400px] mx-auto bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20">
            <div className="flex-1 flex flex-col gap-2">
              <textarea
                ...
                className={`w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 max-h-[200px] min-h-[200px] bg-white/90 backdrop-blur-sm text-gray-800 placeholder-gray-500 glass-scroll
                ${
                  error
